        ...
        <SidebarInset>
          ...
          <main className="p-6 space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-semibold">SACCOs</h1>
                <p className="text-sm text-muted-foreground">Manage SACCO organizations</p>
              </div>
              <RefreshButton />
            </div>

            <Card className="p-4">
              <p className="text-sm text-muted-foreground">This area will list and manage SACCO entities. Coming soon.</p>
            </Card>
          </main>
        </SidebarInset>
      </div>
