  ...
  if (!me.isOwner) {
    return (
      <div className="p-6">
        ...
        <p className="text-sm text-muted-foreground">Only the Owner can manage users.</p>
      </div>
    )
  }
          ...
          <main className="p-6 space-y-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">View and manage roles and activity</p>
              </div>
              <RefreshButton />
            </div>
