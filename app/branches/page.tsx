          ...
          <main className="p-6 space-y-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Manage branches and locations</p>
              </div>
              <RefreshButton />
            </div>

            <Card className="p-4">
              <p className="text-sm text-muted-foreground">Branch list and management will appear here. Coming soon.</p>
            </Card>
          </main>
        </SidebarInset>
      </div>
